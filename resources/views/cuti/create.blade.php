    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
        ...
        <div class="bg-gray-800 pt-3">
            <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                <h3 class="font-bold pl-2">Izin Cuti</h3>
            </div>
        </div>
            ...
            <div class="container w-full md:w-4/5 xl:w-3/5  mx-auto px-2 py-10">
                <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-lg">
                    ...
                    <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" 
                        ...
                        <!-- Mulai Cuti -->
                        <div class="flex flex-wrap">
                            <label for="mulai_cuti" class="block text-gray-700 text-lg font-bold mb-2 sm:mb-4">
                                {{ __('Mulai cuti') }}:
                            </label>

                            <input id="mulai_cuti" type="date" class="form-input w-full @error('mulai_cuti')  border-red-500 @enderror"
                                name="mulai_cuti" value="{{ old('mulai_cuti') }}" required >
                        ...
                        <!-- Selesai Cuti -->
                        <div class="flex flex-wrap">
                            <label for="selesai_cuti" class="block text-gray-700 text-lg font-bold mb-2 sm:mb-4">
                                {{ __('Selesai Cuti') }}:
                            </label>

                            <input id="selesai_cuti" type="date" class="form-input w-full @error('selesai_cuti')  border-red-500 @enderror"
                                name="selesai_cuti" value="{{ old('selesai_cuti') }}" required>
