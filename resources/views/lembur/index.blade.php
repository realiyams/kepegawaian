    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
        ...
        <div class="bg-gray-800 pt-3">
            <div class="rounded-tl-3xl bg-gradient-to-r from-blue-900 to-gray-800 p-4 shadow text-2xl text-white">
                <h3 class="font-bold pl-2">Tabel Lembur</h3>
            </div>
        </div>
        ...
        <div class="flex flex-wrap">
            ...
            <div class="container w-full xl:w-full 2xl:w-4/5  mx-auto px-2 py-10">
                ...
                <button class="bg-blue-500 hover:bg-blue-400 ml-10 text-white font-bold py-2 px-4 mb-5 border-b-4 border-blue-700 hover:border-blue-500 rounded"
                    onclick="window.location.href='/lembur/create'">
                    Ayo Lembur
                </button>
                    ...
                    <table id="example" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                        <thead>
                            <tr>
                                ...
                                <th data-priority="2">Mulai Lembur</th>
                                <th data-priority="3">Selesai Lembur</th>
                                <th data-priority="4">Total Jam</th>
                        ...
                        <tbody>		
                            ...
                            <tr>
                                <td><center>{{ $lembur->karyawan->nama }}</center></td>
                                <td><center>{{ $lembur->mulai_lembur }}</center></td>
                                <td><center>{{ $lembur->selesai_lembur }}</center></td>
                                <td><center>{{ $lembur->total_jam }} jam</center></td>
                                <td><center>@currency($lembur->total)</center></td>
                            </tr>                         
                            @endforeach
                        </tbody>
                    </table>
